...
namespace NotSoSmartSaverAPI.Controllers
{
    ...
    public class ExpensesController : ControllerBase
    {
        ...
        {
            if (VeryTemporary.getMoney(usp.getUserById(data.userId), data.ownerId) >= data.moneyUsed)// && user.userMoney >= expense.moneyUsed)
            {
                exp.createNewExpense(data.ownerId, data.userId, data.expenseName, data.moneyUsed, data.expenseCategory);
